...
/ext/apps_data/gemini_remote/            # our app's data root
/ext/apps_data/gemini_remote/manual/     # manual chapter files
/ext/apps_data/gemini_remote/guide/      # optional shortcut metadata
```
...
// expands to: "/ext/apps_data/gemini_remote/manual"
```
...
if(storage_file_open(file, "/ext/apps_data/gemini_remote/manual/01_getting_started.txt",
...
Pattern for Gemini Remote's manual loader:
...
static const char* default_chapter_content[] = {
    "Gemini CLI is an AI coding agent...",
